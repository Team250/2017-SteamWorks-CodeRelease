 ...
 *
 */
public class AutonRightPegDownField extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public AutonRightPegDownField() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
        ...
        if(DriverStation.getInstance().getAlliance() == DriverStation.Alliance.Red) {
            ...
            addSequential(new TimedDriveField(0,"Auton Red Right Down Field Speed", "Auton Red Right Down Field Time"));
        }
        else
        {
            ...
            addSequential(new WaitCommand(0.25));
            addSequential(new TimedDriveField(0,"Auton Blue Right Down Field Speed", "Auton Blue Right Down Field Time"));
        }
    } 
}
