 ...
 *
 */
public class AutonLeftPegDownField extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public AutonLeftPegDownField() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
        ...
        if(DriverStation.getInstance().getAlliance() == DriverStation.Alliance.Red) {
            ...
            addSequential(new WaitCommand(0.25));
            addSequential(new TimedDriveField(0,"Auton Red Left Down Field Speed", "Auton Red Left Down Field Time"));
        }
        else
        {
            ...
            addSequential(new WaitCommand(0.25));
            addSequential(new TimedDriveField(0,"Auton Blue Left Down Field Speed", "Auton Blue Left Down Field Time"));
        }
    } 
}
